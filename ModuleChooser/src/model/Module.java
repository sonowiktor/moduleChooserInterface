...
public class Module implements Comparable<Module> {
	...
	public Module(String moduleCode, String moduleName, int moduleCredits, boolean mandatory, Schedule schedule) {
	...
	public String actualToString() {
		return "Module:[moduleCode=" + moduleCode + ", moduleName=" + moduleName + 
				", moduleCredits=" + moduleCredits + ", mandatory=" + mandatory + ", schedule=" + schedule + "]";
	}
		...
		if (result == 0) {
			...
			if (result == 0) {
				...
				if (result == 0) {
					...
					if (result == 0) {
						result = this.schedule.compareTo(other.schedule);
					}
				}
	...
	@Override
	public int hashCode() {
		return Objects.hash(mandatory, moduleCredits, moduleCode, moduleName, schedule);
	}
